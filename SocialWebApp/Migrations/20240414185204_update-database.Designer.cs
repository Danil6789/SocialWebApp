...
namespace SocialWebApp.Migrations
{
    ...
    [Migration("20240414185204_update-database")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SocialWebApp.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SocialWebApp.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SocialWebApp.Models.Comment", b =>
                {
                    b.HasOne("SocialWebApp.Models.Post", null)
                        .WithMany("Comments")
                        .HasForeignKey("PostId");

                    b.HasOne("SocialWebApp.Models.Comment", "Reply")
                        .WithMany()
